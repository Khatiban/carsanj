 ...
 */
public class NewFreeHours extends Activity {

    EditText new_moz,new_time,new_toz;
    TextView new_send;
    ImageView back;
...
// java.util.Date dt = jalaliCalendar.getGregorianDate("1392/5/4");
            ...
            public void onClick(View view) {
                ...
                if (n1 != null){
                    ...
                    if (n2 != null){
                            ...
                            BacktoryObject note = new BacktoryObject("FreeHours");
                            ...
                            note.saveInBackground(new BacktoryCallBack<Void>() {
                                ...
                                public void onResponse(BacktoryResponse<Void> response) {
                                    if (response.isSuccessful()) {
                                        ...
                                        Toast.makeText(NewFreeHours.this, "با موفقیت ارسال شد", Toast.LENGTH_LONG).show();
                                    } else {
                                        // see response.message() to know the cause of error
                                        Toast.makeText(NewFreeHours.this, "متاسفانه ارسال نشد!", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });

                    }else {
                        Toast.makeText(NewFreeHours.this, "لطفا مدت ساعت مرخص را وارد کنید", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(NewFreeHours.this, "لطفا موضوع را وارد کنید", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back = new Intent(NewFreeHours.this,FreeHours.class);
                startActivity(back);
                finish();
            }
        });
    ...
    public void onBackPressed() {
        ...
        Intent back = new Intent(this,FreeHours.class);
        startActivity(back);
        finish();

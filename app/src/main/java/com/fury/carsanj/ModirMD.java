...
import com.fury.carsanj.date.Data4;
import com.fury.carsanj.date.MoviesAdapter4;
 ...
 */
public class ModirMD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                PopupMenu menu = new PopupMenu(ModirMD.this, view);
                                                    ...
                                                    public void onResponse(BacktoryResponse<List<BacktoryObject>> backtoryResponse) {
                                                        if (backtoryResponse.isSuccessful()) {
                                                            ...
                                                            for (BacktoryObject todo : todoNotes) {
                                                                ...
                                                                String DateStart = todo.getString("DateStart");
                                                                String DateEnd = todo.getString("DateEnd");
                                                                ...
                                                                if (ti) {
                                                                    ...
                                                                    if (timeInMilliseconds > timeInMilliseconds2) {
                                                                        data.add(new Data4(SM,SD,vis,user,time,TimeMo,Tozih,IV,DateStart,DateEnd));
                                                                    }
                                                                } else {
                                                                    data.add(new Data4(SM,SD,vis,user,time,TimeMo,Tozih,IV,DateStart,DateEnd));
                                                                }
                                                            }
                                                            MoviesAdapter4 adapter = new MoviesAdapter4(data, getApplication());
                                                            recyclerView.setAdapter(adapter);
                                                            recyclerView.setLayoutManager(new LinearLayoutManager(ModirMD.this));
        ...
        BacktoryQuery todoQuery = new BacktoryQuery("FreeDay");
        todoQuery.whereEqualTo("all", "all");
        final ProgressDialog dialog = new ProgressDialog(ModirMD.this);

 ...
 */
public class FreeDay extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent start = new Intent(FreeDay.this,NewFreeDay.class);
                startActivity(start);
                finish();
            }
        });
        ...
        final ProgressDialog dialog = new ProgressDialog(FreeDay.this);
        ...
        todoQuery.findInBackground(new BacktoryCallBack<List<BacktoryObject>>() {
            ...
            public void onResponse(BacktoryResponse<List<BacktoryObject>> backtoryResponse) {
                if (backtoryResponse.isSuccessful()) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(FreeDay.this));

...
public class JalaliCalendar extends Calendar {
    ...
    static final int[] MIN_VALUES = { BCE, 1, FARVARDIN, 1, 0, 1, 1, SATURDAY, 1, AM, 0, 0, 0, 0, 0, -13 * ONE_HOUR, 0 };

    static final int[] LEAST_MAX_VALUES = { CE, 292269054, ESFAND, 52, 4, 28, 365, FRIDAY, 4, PM, 11, 23, 59, 59, 999, 14 * ONE_HOUR, 20 * ONE_MINUTE };

    static final int[] MAX_VALUES = { CE, 292278994, ESFAND, 53, 6, 31, 366, FRIDAY, 6, PM, 11, 23, 59, 59, 999, 14 * ONE_HOUR, 2 * ONE_HOUR };
    ...
    public static YearMonthDate jalaliToGregorian(YearMonthDate jalali) {
        ...
        for (i = 0; gregorianDayNo >= gregorianDaysInMonth
                [i]                + ((i == 1 && leap == 1) ? i : 0); i++) {
